...
logging.basicConfig(format='%(asctime)s - %(filename)s[line:%(lineno)d] - %(levelname)s: %(message)s',
                    ...
                    filemode='w')
# dataset will not change
dataset = load_dataset("ms_marco", 'v1.1', cache_dir=DATASET_PATH)
test_set = dataset["test"]
# tokenizer will not change
tokenizer = AutoTokenizer.from_pretrained("deepset/roberta-base-squad2", cache_dir=TOKENIZER_PATH)
# model WILL change, this should be expressed as
# TODO: Change this to absolute address and stop connection.
...
for row_item in test_set:
    ...
    gen_answer = tokenizer.convert_tokens_to_string(
    ...
    # TODO: How to evaluate correctness among different query type?
